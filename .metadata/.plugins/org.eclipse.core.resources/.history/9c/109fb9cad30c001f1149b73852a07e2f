...
<div class="mb-3">
  ...
  <input type="text" class="form-control" id="n" placeholder="이름 입력..." name="nickName" value="${ses.name }">
</div>
<div class="mb-3">
...
<a href="/user/remove"> <button type="button" class="btn btn-danger" onclick="removePopup()">회원탈퇴</button> </a>
</form>
